...
cpos=np.vstack((cpos,cposm,cposm,cposm,cposm,cposm))
...
cposdp=cposdp.T
#f1_axes.plot(radm)
plt.plot(cprem, label = 'Grupo contole pré')
...
plt.plot(cposm, label = 'Grupo controle pós')
...
plt.title('Velocidade do grupo controle pré e pós')
...
vposdp=vposdp.T
#f1_axes.plot(radm)
plt.plot(vprem, label = 'Grupo vídeo pré')
...
plt.plot(vposm, label = 'Grupo vídeo pós')
